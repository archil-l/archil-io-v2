...
export class SecretsStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: SecretsStackProps) {
    ...
    this.jwtSecret = new secrets.Secret(this, "jwt-secret", {
      secretName: `ask-archil-io-jwt-secret-${envConfig.stage}`,
      description: "JWT signing secret for ask-archil-io application",
    ...
    new cdk.CfnOutput(this, "jwt-secret-arn", {
      ...
      exportName: `ask-archil-io-jwt-secret-arn-${envConfig.stage}`,
    });
  }
}
